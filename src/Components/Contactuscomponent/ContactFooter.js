...
function ContactFooter() {
  return (
    ...
    <Box bg="#0b2558" mt={{base:"40px",lg:"40px"}}   p={{base:"10px",lg:"30px"}} flexDirection={{base:"row",lg:"row"}} w={{base:"1100px", lg:'100%'}} h={{base:"none", lg:"100%"}}>
      <Box  display={{base:"flex", lg:"flex"}}   borderBottom="2px solid white" m="30px"  >
        <Box borderRight={{base:"2px solid #fff",lg:"2px solid #fff"}} m="30px"  pr="30px">
          <Box  ml={{base:"20px",lg:"100px"}}>
            <Heading mb="10px" fontFamily='Playfair Display'   color="#fff" >
            SHRIVEDAA
            </Heading>
            <Box color="#fff">
